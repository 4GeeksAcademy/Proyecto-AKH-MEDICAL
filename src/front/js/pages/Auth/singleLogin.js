        ...
        <div style={{ backgroundImage: 'url("https://img.freepik.com/fotos-premium/largo-corredor-hospital-equipo-medico-blanco-casilleros_124507-44132.jpg")', backgroundSize: 'cover' }}>
            <div className="row">
                <div className="col-12 vh-100 d-flex flex-column justify-content-center align-items-center">
                    <div className="mb-5">
                        <form className="mb-5 pt-3 ps-3 pe-3 pb-3 bg-white text-center" style={{ borderRadius: "15px", border: "3px solid gray" }}>
                            <h1 className="text-center mb-4 text-black"><i>LOGIN</i></h1>
                            <div>
                            ...
                            <button type="button" onClick={(e) => login(e)} className="btn btn-outline-success mt-3 ps-4 pe-4"><b>Login</b></button>
                        </form>
                    </div>
                </div>
            </div>
